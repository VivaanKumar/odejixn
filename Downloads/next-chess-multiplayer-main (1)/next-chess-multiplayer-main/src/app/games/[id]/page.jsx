      ...
      <div className="h-[100%] w-[65%] flex justify-center items-center space-x-6 flex-row-reverse space-x-3">
        {side ? (
          <div className="flex flex-col space-y-0 w-[250px] flex-grow-1 justify-start items-start backdrop-blur-md">
            <div className="flex flex-col space-y-[12px] items-start h-fit z-[100]">
              ...
              <div className="flex items-center justify-center w-[250px]">
                ...
                <p
                  className={`bg1 h-[48px] w-[202px] flex-col flex items-center justify-center text-[12px] text-[#9b9b9b] rounded-r-[12px] rounded-br-[0px] ${playingAgainst
                    ? ""
              ...
              <>
                ...
                <div title="Turn off piece move animations." className="space-x-2 flex items-center">
                    ...
                    <Switch
                      ...
                      // defaultChecked="T"
                      className={`${animation ? 'bg-green-700' : 'bg-red-700'}
          relative inline-flex h-[38px] w-[74px] shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring-2  focus-visible:ring-white focus-visible:ring-opacity-75`}
            ...
            pointer-events-none inline-block h-[34px] w-[34px] transform rounded-full bg-white shadow-lg ring-0 transition duration-200 ease-in-out`}
                  ...
                  <div title="Allow the option to use arrows on right-click drag." className="space-x-2 flex items-center">
                    
                    <Switch
                      checked={arrows}
                      onChange={setArrows}
                      // defaultChecked="T"
                      className={`${arrows ? 'bg-green-700' : 'bg-red-700'}
          relative inline-flex h-[38px] w-[74px] shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring-2  focus-visible:ring-white focus-visible:ring-opacity-75`}
                    >
                      {/* <span className="sr-only">Use setting</span> */}
                      <span
        ...
        <div className="space-y-3 mr-2">
            ...
            <div className="flex items-end justify-between">
              ...
              <div className="scale-[0.70] translate-y-[9.5px] shadow-2xl">
                {entireGame?.draw && entireGame?.draw !== ourUser?.email && (
                  <div className="bg1 flex w-[250px] h-fit justify-between  items-center space-x-3 gap-3 rounded-[12px] p-[2px]">
          ...
          <div>
            ...
            />
            {state && (
              <div className="p-6 z-[10] w-[430px] h-[430px] absolute translate-y-[-430px] translate-x-[6px] scale-[1.026] bg-[#00000097] backdrop-blur-[2px]">
